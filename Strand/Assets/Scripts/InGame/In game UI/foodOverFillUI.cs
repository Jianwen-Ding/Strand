...
public class foodOverFillUI : MonoBehaviour
{
    [SerializeField]
    float leftX;
    [SerializeField]
    ...
    void Update()
    {
        float actualRightX = leftX + (maxRightX - leftX) * (getResource.getHungerOverfillLeft() / getResource.getHungerOverfillUntilHeal());
